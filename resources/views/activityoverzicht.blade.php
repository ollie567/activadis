                    ...
                    ?>
                        <tbody class="table-group-divider">
                            <tr>
                                ...
                                <td><a href="/detailPagina?id={{$activ->ID}}"><button class="btn btn-primary" type="submit">info</button></a></td>
                                <td><a href="/adminDetail?id={{$activ->ID}}"><button class="btn btn-secondary" type="submit">aanpassen</button></a></td>
                                <td>
