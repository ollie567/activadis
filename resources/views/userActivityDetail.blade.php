...
<h1 class="w-100 text-left m-1" style="padding-left: 250px">{{$activ->activiteitnaam}}</h1>
<div class="d-flex justify-content-lg-start" style=" width: 100%">

    <div style="width: 100%; padding-left: 100px">
        <div id="carouselExampleIndicators" class="carousel slide w-100 mt-1" data-ride="carousel">
            <div class="carousel-inner" >
                <div class="carousel-item active w-100">
                    <img class="d-block w-100" src="{{$activ->activiteitafbeelding}}" alt="First slide" style="height: 500px;">
                </div>
            </div>
        </div>
    ...
    <div class="mt-1 d-flex flex-row flex-wrap justify-content-center">
        <div class="card m-1 p-10" style="width: 18rem;">
            <div class="card-body" style="padding: 10px">
                <div class="card-header"><h4 class="card-title">Locatie</h4></div>
                <p class="card-text" style="">{{$activ->activiteitlocatie}} om {{$activ->activiteitbegintijd}} tot {{$activ->activiteiteindtijd}}</p>
            </div>
        </div>
